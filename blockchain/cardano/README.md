# Cardano Blockchain Environment Information
---
...
- [All Documentation via `via cardano.org`](https://docs.cardano.org)
- [Research Library `via IOHK.io`](https://iohk.io/en/research/library/)
- [Relevant Research Papers and Specifications `via cardano.org`](https://docs.cardano.org/about-cardano/explore-more/relevant-research-papers/)
...
- [IOG Technical Community Discord](https://discord.com/invite/5kaErDKDRq)
...
- [Stake Pool Operations `via cardano.org`](https://docs.cardano.org/stake-pool-operators/operating-a-stake-pool/)
...
- [Node Repository](https://github.com/input-output-hk/cardano-node#overview-of-the-cardano-node-repository)
- [Node Video Cource](https://docs.cardano.org/developer-resources/cardano-node-course/)

##### Testnet

- [Testnet Environment](https://docs.cardano.org/cardano-testnets/environments/)
...
- [Cardano Solutions](https://github.com/CardanoSolutions/zhuli)
- [Ogmios Project](https://ogmios.dev/faq/#are-there-any-projectscompanies-using-it)
- [Fortuna - Cardano L2](https://minefortuna.com/)

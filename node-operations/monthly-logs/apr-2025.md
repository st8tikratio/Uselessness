...
- [28 April](https://github.com/st8tikratio/Uselessness/blob/main/node-operations/monthly-logs/apr-2025.md#28-april-2025)
  ```
  1810 UTC -- Created backup of 100% synced Mainnet node
...
##### 28 APRIL 2025
- [CREATE BACKUP OF MAINNET NODE - `1810 UTC`](https://github.com/st8tikratio/Uselessness/blob/main/node-operations/monthly-logs/apr-2025.md#create-backup-of-mainnet-node---1810-utc)
...
## CREATE BACKUP OF MAINNET NODE - `1810 UTC`
Using:
```
scripts/dandoman.sh
```

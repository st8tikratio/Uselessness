...
- [PRIMARY NODE `DRIVE` CHECK](https://github.com/st8tikratio/Uselessness/blob/main/node-operations/apr-2025.md#primary-node-drive-info---from-smartmontools)

### PRIMARY NODE DRIVE INFO - `from smartmontools`
Date/Time:
```

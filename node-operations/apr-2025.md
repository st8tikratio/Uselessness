...
- [25 April](https://github.com/st8tikratio/Uselessness/blob/main/node-operations/apr-2025.md#25-april-2025)
  ...
  Various script checks for both containers to determine if any errors
...
- [24 April](https://github.com/st8tikratio/Uselessness/blob/main/node-operations/apr-2025.md#24-april-2025)
  ```
  Spun down both nodes and brought them back up
...
- [VOLUME SCRIPT CHECKS & KOIOS TIP]()
  - [MAINNET]()
    - [cardano-dbsync check]() • [ogmios check]() • [koios tip]()
  - [PREPROD]()
    - [cardano-dbsync check]() • [ogmios check]() • [koios tip]()
